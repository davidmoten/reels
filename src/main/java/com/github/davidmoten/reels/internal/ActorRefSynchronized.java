...
public class ActorRefSynchronized<T> extends ActorRefImpl<T> {

    private final AtomicInteger wip = new AtomicInteger();

    protected ActorRefSynchronized(String name, Supplier<? extends Actor<T>> factory, Scheduler scheduler,
