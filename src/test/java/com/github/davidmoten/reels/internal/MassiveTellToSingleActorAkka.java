...
public class MassiveTellToSingleActorAkka {
    ...
    private static class Master extends AbstractActor {
        ...
        public Receive createReceive() {
            return receiveBuilder().match(StartMessage.class, msg -> start()).match(Integer.class, this::runnerReplied)
                    .build();
        }
    ...
    private static class Runner extends AbstractActor {
        ...
        @Override
        public Receive createReceive() {
            return receiveBuilder().match(Integer.class, i -> run(i)).build();
        }
